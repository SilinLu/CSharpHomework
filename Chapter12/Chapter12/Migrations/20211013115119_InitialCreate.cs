        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Customers_Customer_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderDetailId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    good_GoodId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orderDetails_Goods_good_GoodId",
                        column: x => x.good_GoodId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_orderDetails_good_GoodId",
                table: "orderDetails",
                column: "good_GoodId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_Customer_CustomerId",
                table: "Orders",
